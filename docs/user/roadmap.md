...
- **Epic 4** — simulator framework (4.1), driver family + `*OPT?`
  refinement pattern (4.2), three new instrument kinds (4.3
  electronic load, 4.4 signal generator, 4.5 spectrum analyzer),
  seven vendor packs (4.6 Siglent, 4.7 Keysight + legacy Agilent,
  4.8 Owon, 4.10 Tektronix, 4.11 Rohde &amp; Schwarz + legacy HAMEG,
  4.12 Fluke, 4.13 GW Instek), and the
...
## In flight — Epic 5 (bench safety) and Epic 6 (UX pass)
...
- **Epic 6 — UX pass.** Keyboard shortcuts with a discoverable help
  ...
  onto the hero row, etc. (6.2); one-click GitHub hardware / bug
  reports prefilled from live identity + transcript tail (6.3); i18n
  + locale-aware formatting for the dashboard SPA (6.4); bounded
  visual polish (6.5); and a small VitePress manual readability pass
  (6.6).
